    ...
    if request.method == 'POST':
        ...
        if(class_name1[:-1]=="Skin"):
            ...
            if(class_name2[:-1]=="cancer skin"):
                ...
                result=f"Class: {class_name3},Confidence Score: {confidence_score3}"
                return result
            else:
                result=f"Class: {class_name2},Confidence Score: {confidence_score2}"
                return result
        else:
            result = f"Class: {class_name1}, Confidence Score: {confidence_score1}"
            return result
